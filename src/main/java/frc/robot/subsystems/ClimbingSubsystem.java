...
public class ClimbingSubsystem extends SubsystemBase {
  ...
  private RelativeEncoder ClimbingEncoder = ClimbingRMotor.getEncoder();
  ...
  public ClimbingSubsystem() {
    ...
    ClimbingRMotor.enableSoftLimit(CANSparkMax.SoftLimitDirection.kForward, false);
    ClimbingRMotor.enableSoftLimit(CANSparkMax.SoftLimitDirection.kReverse, false);

    ClimbingRMotor.setSoftLimit(CANSparkMax.SoftLimitDirection.kForward, (float) ClimbingConstants.kUPLimit);
    ClimbingRMotor.setSoftLimit(CANSparkMax.SoftLimitDirection.kReverse, (float) ClimbingConstants.kDownLimit);
  }
  ...
  public double getHangingPosition() {
    return ClimbingEncoder.getPosition();
  }
