...
public class AngleSubsystem extends SubsystemBase {
  ...
  public AngleSubsystem() {
    ...
    AnglePIDcontroller.setFeedbackDevice(AngleAbsEncoder);
  ...
  //   AnglePIDcontroller.setReference(AngleConstants.kInakePosition, ControlType.kPosition);
  // }

  public void setSpeaker() {
    AnglePIDcontroller.setReference(AngleConstants.kSpeakerPosition, ControlType.kPosition);
  }

  public void setStage() {
    AnglePIDcontroller.setReference(AngleConstants.kStagePosition, ControlType.kPosition);
  }
  ...
  public void hold() {
    AnglePIDcontroller.setReference(getAngleAbsolutePosition(), ControlType.kPosition);
  }
}
