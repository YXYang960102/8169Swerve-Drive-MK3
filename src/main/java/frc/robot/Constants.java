...
public final class Constants {
  ...
  public static class AngleConstants {
    ...
    public static final double kAngleMotorRate = 0.2;

    // AnglePosition
    // public static final double kInakePosition = 0.0;
    public static final double kSpeakerPosition = 118.80;
    public static final double kStagePosition = 140.00;
    public static final double kDefultPosition = 148.00;
  ...
  public static class AMPConstants {
    ...
    // AMP Arm limit
    // public static final double kUPLimit = ;
